...
### Distribution of participants under each health status, by age over follow-up

```{r cancerf7, echo=FALSE, fig.cap = '(ref:cancerf7)'}
knitr::include_graphics(here::here("figs", "cancerf7.jpg"))
```

(ref:cancerf7) A legend
...
### Causes of death defined by ICD-10 codes for participants who died prior to dementia diagnosis
