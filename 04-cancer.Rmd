...
\chaptermark{Clearer causal questions for cancer and dementia association}
...
```
(ref:cancert1) Characteristics of cohort at baseline (n = 3634)
...
```{r cancerf6, echo=FALSE, fig.cap = '(ref:cancerf6)', fig.align = 'center', fig.show = 'asis'}
...
```{r cancerf7, echo=FALSE, fig.cap = '(ref:cancerf7)', fig.align='center'}
...
```{r cancerf8, echo=FALSE, fig.cap = '(ref:cancerf8)', fig.align='center'}
