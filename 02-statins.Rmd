...
```
(ref:statinst2) Characteristics of eligible individuals at the start of the trial's follow-up
...
```
(ref:statinst3) Modified intention-to-treat analysis: 5-year and 10-year risks of dementia and dementia/death
...
table2.3 %>%
  ...
  kable_styling(
    ...
    footnote(general = "*Adjusted for baseline covariates; **Adjusted for baseline and time-varying covariates", threeparttable=T)
```
(ref:statinst4) Per-protocol analysis: 5-year and 10-year risks of dementia and dementia/death

\newpage
\blandscape

```{r statinsf2, echo=FALSE, fig.cap = '(ref:statinsf2)', out.width="100%", fig.align='center', auto_pdf = TRUE}
...
```{r statinsf3, echo=FALSE, fig.cap = '(ref:statinsf3)', out.width="100%", fig.align='center', auto_pdf = TRUE}
