...
table2.1 %>%
  kable(booktabs = TRUE,
        ...
        align = "lll") %>% # alineacion configurada
  kable_styling(
    full_width = F,
    position = 'center',
  ...
  column_spec(1, width = "1.5cm") %>% #ajustar el largo de las columnas
  column_spec(2, width = "5cm") %>%
  column_spec(3, width = "5cm") %>%
  row_spec(0, 0, bold = TRUE) %>%
  footnote(general = "*Serious illness defined as cancer or heart disease. Following a serious illness, participants may or may not take statin therapy, as guided by their physicians.", threeparttable =
             T) #ajustar el scaling del footnote
```
...
```{r statinsf1, echo=FALSE, fig.cap = '(ref:statinsf1)'}
knitr::include_graphics(here::here("figs", "statinsf1.png"))
```
...
```{r statinsf2, echo=FALSE, fig.cap = '(ref:statinsf2)', auto_pdf = TRUE}
...
```{r statinsf3, echo=FALSE, fig.cap = '(ref:statinsf3)', auto_pdf = TRUE}
