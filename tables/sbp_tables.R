...
table3.4 <- tibble::tribble(
  ...
  "1.4 (1.12, 1.64)",
  "2.8 (0.8, 4.5)",
  "Without hypertension medication at baseline",
  "3570",
  "9 (8.1, 10.6)",
  "7 (5.8, 9.1)",
  "0.78 (0.66, 0.94)",
  ...
  "1.12 (0.95, 1.27)",
  "1.1 (-0.4, 2.4)",
  "No history of heart disease at baseline",
  "4406",
  "9.9 (9.1, 10.9)",
  "8.2 (6.8, 10.1)",
  "0.83 (0.7, 0.99)",
...
table3e1 <- tibble::tribble(
  ...
  "Individuals below 80 years old, with no prior history of stroke or transient ischemic attack, cognitive impairment, dementia diagnosis or Parkinson  or Parkinsonism.",
...
table3e2 <- tibble::tribble(
  ...
  "Women, n (\\%)",  "2824 (57.3)",   "155 (58.9)",
  "APOE $\\varepsilon4$ carrier",  "1322 (28.1)",    "59 (30.7)",
  "Education, n (\\%)",               NA,               NA,
  "Primary", "2378 (48.6)", "122 (56.5)",
  "Further", "2044 (41.8)", "78 (36.1)",
  "Higher", "472 (9.6)", "16 (7.4)",
  "Prevalent heart disease, n (\\%)", "368 (7.7)", "22 (13.3)",
  "Prevalent diabetes, n (\\%)", "432 (12.9)", "16 (16.3)",
  "Prevalent cancer, n (\\%)", "20 (0.4)",  "1 (0.4)")
...
table3e3a <- tibble::tribble(
  ...
  "Education at baseline", "1st visit", "4 categories",
  "Higher (4); Further (3); Primary (2); Missing (1)",
  "Sex", "1st visit", "2 categories", "Female; male",
  "APOE $\\varepsilon4$ carrier status", "1st visit", "3 categories", 
...
table3e3b <- tibble::tribble(
  ...
  "1st - 4th visit",
  "5 categories",
  "$\\geq$ 10 g\\/day (5);  5 - 10 g\\/day (4); 1 - 5 g\\/day  (3); $<$ 1  g\\/day (2); Missing (1)",
  ...
  "1st, 3rd, 4th visit",
  "4 Categories",
  "$\\geq$ (4); $>$ 5.17 \\& $<$ 6.21 (3); $\\leq$ 5.17  (2);  Missing (1)",
  ...
  "Indicator and time since switch",
  "N\\/A",
  "Diagnosis of Parkinsons Disease or Parkinsonism",
  "Year of diagnosis",
  "Indicator and time since switch",
  "N\\/A",
