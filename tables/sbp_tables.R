...
table3.4 <- tibble::tribble(
  ~ `Subgroup`,
  ~ `Risk under natural course (95% CI)_1`,
  ~ `Risk under joint intervention (95% CI)_1`,
  ~ `Risk ratio (95% CI)_1`,
  ~ `Risk Difference (95% CI)_1`,
  ~ `Risk under natural course (95% CI)_2`,
  ~ `Risk under joint intervention (95% CI)_2`,
  ~ `Risk ratio (95% CI)_2`,
  ~ `Risk Difference (95% CI)_2`,
  "Complete cohort",
  "10.3 (9.3, 11.5)",
  "8.5 (7.2, 9.9)",
  "0.83 (0.71, 0.94)",
