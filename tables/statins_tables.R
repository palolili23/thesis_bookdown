...
table2.1 <-
  tibble::tribble(
    ...
    known to be dementia free, MMSE $\\geq$ 26 at enrollment;
...
calendar year, smoking status, MMSE, BMI, APOE $\\varepsilon4$ carrier status, cholesterol, SBP, stroke, smoking status,
...
NA, "Per-protocol analysis", "Same per-protocol analysis, except that time since most recent MMSE measurement 
...
table2.2 <- tibble::tribble(
  ...
  "   Unknown","1.2\\%", "0.8\\%",
  "APOE $\\varepsilon4$ carrier (\\%)", NA, NA,
  "   Yes","25.8\\%","28.3\\%",
  "   No","70.2\\%","66.4\\%",
  "   Missing","4.0\\%","5.3\\%",
...
table2e2 <- tibble::tribble(
  ...
  ~ `Statins %(95%CI)_2`,
  ~ `Risk Difference (95\\%CI)`,
  "Main result(Table 2.4 and Figure 2.3)",
  622L,
  232904,
  "11.2 (10.6, 11.8)",
  "8.5 (5.4, 11.1)",
  ...
  "21.0 (15.6, 25.7)",
  "-5.1 (-10.5, -1.1)",
  "Baseline calendar year 2000 or later",
  441L,
  146142,
  "10.3 (9.5, 11.0)",
  "7.1 (5.0, 9.7)",
  ...
  "20.2 (14.8, 26.0)",
  "-3.7 (-9.3, 2.6)",
  "Exclude individuals 70 years of age or older at baseline",
  339L,
  126228,
  "5.9 (5.2, 6.6)",
  "5.3 (2.9, 8.4)",
  ...
  "13.0 (7.6, 17.6)",
  "-1.5 (-7.4, 3.5)",
  "Restrict to individuals 70 years of age or older at baseline",
  283L,
  106676,
  "17.7 (16.6, 18.7)",
  "13.3 (9.1, 17.8)",
  ...
  "22.6 (17.8, 28.7)",
  "-7.3 (-12.0, -0.7)",
  "Exclude history of heart disease or stroke at baseline",
  393L,
  190725,
  "9.7 (9.1, 10.3)",
  "6.6 (3.7, 11.2)",
  ...
  "16.2 (11.0, 22.8)",
  "-7.1 (-12.9, -0.1)",
  "Exclude those taking vascular medications* at baseline",
  218L,
  141329,
  "9.1 (8.4, 9.7)",
  "5.0 (1.7, 9.2)",
  ...
  "15.0 (6.9, 22.6)",
  "-6.8 (-15.1, 0.9)",
  "Exclude high cholesterol ($>$6.2 mmol/L)",
  254L,
  140572,
  "12.1 (11.1, 12.9)",
  "10.9 (6.6, 15.7)",
  ...
  "25.9 (19.8, 33.0)",
  "-1.3 (-7.2, 6.3)",
  "Restrict to high cholesterol ($>$6.2 mmol/L)",
  368L,
  92332,
  "9.8 (8.8, 10.7)",
  "6.5 (2.9, 11.0)",
  ...
  "21.3 (17.4, 25.1)",
  "-3.7 (-7.8, 0.1)",
  "MMSE $\\geq$ 26 at baseline but need not be in the previous 3 years",
  658L,
  246962,
  "11.2 (10.6, 11.8)",
  "8.8 (6.3, 11.3)",
