...
We begin by briefly describing the target trial specifications and then how we attempt to emulate the trial using data from the Rotterdam Study. A detailed comparison between the target trial and the emulation using observational data, is provided in the Supplementary information, Table s1.
...
```
(ref:sbpt4) Emulation of a target trial of multiple and joint strategies to lower the risk of stroke among adults from 55 to 80 years old.
...
```
(ref:sbpt5) Comparison of baseline characteristics for included and excluded participants.
...
```
(ref:sbpt7) Time-varying covariates
...
```
(ref:sbpt8) Death as a censored event. The observed risk at 15 years is 12.0% .
...
stroke3 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt9) Stroke and death as combined outcome. The observed risk at 15 years is 36.4%.  
...
stroke4 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt10) Under 65 years subgroup. The observed risk at 15 years is 6.1%.  
...
stroke5 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt11) Above 65 years and below 80 years subgroup. The observed risk at 15 years is 14.0%.
...
stroke_women %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt12) Women subgroup. The observed risk at 15 years is 9.2 %.
...
stroke_men %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt13) Men subgroup. The observed risk at 15 years is 11.6 %.
...
stroke_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt14) Without hypertension medication at baseline subgroup. The observed risk at 15 years is 8.8 %.
...
stroke_nohd %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt15) No history of heart disease at baseline subgroup. The observed risk at 15 years is 9.9%.  
...
dementia2 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt16) Death as a censored event. The observed risk at 15 years is 10.8%.  
...
## References
(ref:sbpt17) Dementia and death as combined outcome. The observed risk at 15 years is 36.7%.  
...
dementia4 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt18) Under 65 years subgroup. The observed risk at 15 years is 3.2%.
...
dementia5 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt19) Above 65 years and below 80 years subgroup. The observed risk at 15 years is 14.1%. 
...
dementia_women %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt20) Women subgroup. The observed risk at 15 years is 10.7%.
...
dementia_men %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt21) Men subgroup. The observed risk at 15 years is 6.7%. 
...
dementia_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt22) Without hypertension medication at baseline subgroup. The observed risk at 15 years is 8.6%.
...
dementia_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt23) Free of heart disease at baseline subgroup. The observed risk at 15 years is 8.6%. 
