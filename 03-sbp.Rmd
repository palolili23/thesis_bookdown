...
```{r sbpf1, echo=FALSE, fig.cap = '(ref:sbpf1)', auto_pdf = TRUE, fig.align='center', fig.pos= 'H'}
knitr::include_graphics(here::here("figs", "sbpf1.jpg"))
```
(ref:sbpf1) **Flowchart.**
...
```{r sbpf2, echo=FALSE, fig.cap = '(ref:sbpf3)', fig.align='center', fig.pos= 'H'}
knitr::include_graphics(here::here("figs", "sbpf2.jpg"))
```
...
knitr::include_graphics(here::here("figs", "sbpf3.jpg"))
```
