...
table3.4 %>%
  ...
  add_header_above(c(" " = 1, "Stroke" = 4, "Dementia" = 4)) %>% 
...
```{r sbpf4, echo=FALSE, fig.cap = '(ref:sbpf4)'}
...
```{r sbpf5, echo=FALSE, fig.cap = '(ref:sbpf5)'}
...
stroke2 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt9) Death as a censored event. The observed risk at 15 years is 12.0% .
...
stroke3 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt10) Stroke and death as combined outcome. The observed risk at 15 years is 36.4%.  
...
stroke4 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt11) Under 65 years subgroup. The observed risk at 15 years is 6.1%.  
...
stroke5 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt12) Above 65 years and below 80 years subgroup. The observed risk at 15 years is 14.0%.
...
stroke_women %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt13) Women subgroup. The observed risk at 15 years is 9.2 %.
...
stroke_men %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt14) Men subgroup. The observed risk at 15 years is 11.6 %.
...
stroke_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt15) Without hypertension medication at baseline subgroup. The observed risk at 15 years is 8.8 %.
...
stroke_nohd %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt16) No history of heart disease at baseline subgroup. The observed risk at 15 years is 9.9%.  
...
dementia2 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt17) Death as a censored event. The observed risk at 15 years is 10.8%.  
...
dementia3 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt18) Dementia and death as combined outcome. The observed risk at 15 years is 36.7%.  
...
dementia4 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt19) Under 65 years subgroup. The observed risk at 15 years is 3.2%.
...
dementia5 %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt20) Above 65 years and below 80 years subgroup. The observed risk at 15 years is 14.1%. 
...
dementia_women %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt21) Women subgroup. The observed risk at 15 years is 10.7%.
...
dementia_men %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt22) Men subgroup. The observed risk at 15 years is 6.7%. 
...
dementia_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt23) Without hypertension medication at baseline subgroup. The observed risk at 15 years is 8.6%.
...
dementia_freemed %>%
  ...
  footnote(general = "95%CI based on 500 bootstraps")
```
(ref:sbpt24) Free of heart disease at baseline subgroup. The observed risk at 15 years is 8.6%. 
