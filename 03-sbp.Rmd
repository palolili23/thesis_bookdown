...
```{r 03_fig1, fig.cap='(ref:Flowchart)', results='show'}
knitr::include_graphics("figs/03_fig1.JPG", auto_pdf = TRUE)
```
...
#### Figure s1. Outcome: Stroke

#### Figure s2. Outcome: Dementia
