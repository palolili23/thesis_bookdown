...
library(pander)
library(gt)
source(here::here("tables", "tables3sbp.R"))
...
### Table s1.Target trial description
...
### Table s2. Characteristics of included and excluded (missing covariates) participants 


### Table s3. How things were modeled
