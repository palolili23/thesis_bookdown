...
```{r sbpf1, echo=FALSE, fig.cap = '(ref:sbpf1)', auto_pdf = TRUE, fig.align='center', fig.pos= 'H', out.width = '120%'}
...
table3.4 %>%
  ...
  column_spec(c(3:10), width = "1.5cm") %>% 
  add_header_above(c("", "", "Stroke" = 4, "Dementia" = 4), bold = TRUE)
```
(ref:sbpt4) Effect of joint intervention: Reduce SBP by 20% if above 140 mmHg and quit smoking in the risk of stroke and dementia by subgroups
...
```{r sbpt6, echo= FALSE, warning = FALSE, results='asis'}
table3e2 %>%
  kable(booktabs = TRUE,
        caption = '(ref:sbpt6)',
        align = "lcc") %>%
...
```{r sbpt7, echo= FALSE, warning = FALSE, results='asis'}
table3e3a %>%
  kable(booktabs = TRUE,
        caption = '(ref:sbpt7)',
        align = "lccl") %>%
